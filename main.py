...
class Serie(Entregable):
    ...
    #Metodos
    def __str__(self):
        return f'Serie(Titulo: {self.titulo}, Temporadas: {self.temporadas}, Genero: {self.genero}, Creador: {self.creador}'
...
class Videojuego(Entregable):
    ...
    #Metodos
    def __str__(self):
        return f'Videojuego(Titulo: {self.titulo}, Horas Estimadas: {self.horas_estimadas}, Genero: {self.genero}, Compañia: {self.compania}'
...
if __name__ == '__main__':
    ...
    print(f'{seriemax.titulo} es la serie con mas temporadas ({seriemax.temporadas} temporadas)')

    juegomax = max(juegos, key=attrgetter('horas_estimadas'))
    print(f'{juegomax.titulo} es el juego con mas horas estimadas ({juegomax.horas_estimadas} horas estimadas)')
